...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="px-8 pt-2 pb-10">
            <form action="{{ route('secrets.store') }}" method="POST" class="space-y-8">
                ...
                <div class="space-y-2">
                    <label for="content" class="block text-sm font-semibold text-gray-700">Secret Content</label>
                ...
                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <label for="require_password" class="text-sm font-semibold text-gray-700">Password Protection</label>
                        ...
                        <label class="relative inline-block w-14 h-7">
                            ...
                            <div class="dot absolute top-0.5 left-0.5 w-6 h-6 bg-white rounded-full transition-transform duration-200 ease-in-out shadow-sm"></div>
                        </label>
                    </div>
        ...
        <div class="px-8 py-8">
                ...
                <div class="bg-white rounded-lg p-6 border border-blue-100">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Your secret is encrypted using industry-standard encryption before being stored. The encryption key is embedded directly into the unique sharing URL, ensuring that even our administrators cannot access your secret's contents.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 border border-blue-100">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Each secret can only be accessed once. The moment someone opens your sharing link and views the secret, it is permanently destroyed from our servers.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 border border-blue-100">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">All secrets automatically expire and are permanently deleted after one hour, regardless of whether they have been accessed.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 border border-blue-100">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Even in the unlikely event of a database breach, attackers would find only encrypted data that cannot be decrypted without the corresponding URLs.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-amber-700 space-y-2">
                            <p>Once you create a secret, we will display a unique sharing URL. <strong>This is the only time you will ever see this link.</strong> We do not store the complete URL anywhere in our system – the encryption key exists only in that link.</p>
                            <p>If you navigate away from this page, refresh your browser, or close the tab before copying the link, <strong>it will be lost forever and cannot be recovered.</strong> We cannot regenerate the link or provide access to your secret by any other means.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-blue-100 p-6">
                ...
                <ul class="text-sm text-gray-600 space-y-2">
                    ...
                    <li class="flex items-start space-x-2">
                        <span class="flex-shrink-0 w-1.5 h-1.5 bg-blue-400 rounded-full mt-2"></span>
                        <span>Verify the link works before sharing it with the intended recipient (remember not to decrypt the link or it will be destroyed)</span>
                    </li>
                    <li class="flex items-start space-x-2">
                        <span class="flex-shrink-0 w-1.5 h-1.5 bg-blue-400 rounded-full mt-2"></span>
                        <span>Remember that the secret will be destroyed after the first view or one hour, whichever comes first</span>
                    </li>
                    <li class="flex items-start space-x-2">
                        <span class="flex-shrink-0 w-1.5 h-1.5 bg-blue-400 rounded-full mt-2"></span>
            ...
            <div class="text-center mt-6 text-sm text-gray-600">
                <p class="italic">Your privacy and security are our top priorities. Vito is designed to ensure that sensitive information can be shared safely while maintaining complete confidentiality.</p>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-6">
        <a href="{{ route('terms') }}" class="text-sm text-gray-500 hover:text-gray-700 underline transition-colors duration-200">
            Terms of Use
        </a>
    </div>
</div>
