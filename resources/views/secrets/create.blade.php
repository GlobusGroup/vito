        ...
        <div class="px-6 py-8">
            ...
            <form action="{{ route('secrets.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="content" maxlength="190000" id="content" rows="4" class="px-2 py-1 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" required></textarea>
                </div>
