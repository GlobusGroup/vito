...
@section('content')
      ...
      <div class="px-6 py-8">
        <div class="space-y-6">
          ...
          <div>
              ...
              <div id="password-section">
                <div class="mb-4">
                  ...
                  <input
                    ...
                    id="password" type="password" maxlength="100" placeholder="Enter password">
                </div>
              </div>
            @endif
            <div class="w-full">
              <div
                class="text-2xl font-mono tracking-wider text-center bg-gray-50 p-4 rounded border border-gray-200 flex justify-center"
                id="secret-display">
                <button
            ...
            <div class="hidden flex justify-center space-x-3 mt-6" id="action-buttons">
              <button
  ...
  <div class="text-center mt-6">
    ...
    {{-- github link --}}&nbsp;
    <a class="text-sm text-gray-500 hover:text-gray-700 underline transition-colors duration-200"
      href="https://github.com/GlobusGroup/vito" target="_blank">
      GitHub
    </a>
  </div>
        ...
        decryptBtn.addEventListener('click', async function() {
          ...
          try {
            ...
            secretDisplay.innerHTML =
              '<span class="text-2xl font-mono tracking-wider">••••••••••••••••••••••</span>';
